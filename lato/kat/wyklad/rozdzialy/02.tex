...
\begin{itemize}
  ...
  \item a morfizmy to strzałki takie, że diagram
    \begin{center}
      \begin{tikzcd}
        C\arrow[rr] & & D\\ 
                    & F\arrow[ur, Rightarrow]\arrow[ul, Rightarrow]
      \end{tikzcd}
    \end{center}
    komutuje.
\end{itemize}
...
\begin{definition}{granica funktora}{}
  \buff{Granicą} funktora $F$, $\lim F$, nazywamy obiekt początkowy w wyżej zdefiniowanej kategorii naturalnych przekształceń. \buff{Granica odwrotna} to wtedy obiekt końcowy $\varprojlim F$.
\end{definition}
