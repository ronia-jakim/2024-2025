...
\end{example}
  ...
  Niech $\Gamma$ będzie grupą hiperboliczną. Wówczas $\partial_\infty \Gamma$ jest zwartą przestrzenią o skończonym wymiarze topologicznym, w naturalny sposób kompleksyfikującą graf Cayleya $C(\Gamma,S)$
